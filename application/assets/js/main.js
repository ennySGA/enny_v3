...
$("#add-check").click(function(){
	var ht1="<div class='controls'><input type='text' name='cuerpo[]' placeholder='Opción del checklist' />\n";
	var ht3="<button class='del-reg btn btn-danger btn-mini'><i class='icon-trash'></i> Borrar</button>\n";
	var ht2="<div class='checkinline'><input type='checkbox' name='status[]' ></div> "+ht3+"</div>\n";
	$(this).parent().children('.control-group').append(ht1+ht2);
...
$('#nuevo-impacto').click(function(){
	$('.nuevo-impacto-w').show();
});
$('#nuevo-archivo').click(function(){
	$('.nuevo-archivo-w').show();
});
$('#nuevo-meta').click(function(){
	$('.nuevo-meta-w').show();
});
$('#nuevo-galeria').click(function(){
	$('.nuevo-galeria-w').show();
});
$('#nuevo-legislacion').click(function(){
	$('.nuevo-legislacion-w').show();
});
$('#nuevo-emergencia').click(function(){
	$('.nuevo-emergencia-w').show();
});
$('#nuevo-comentario').click(function(){
	$('.nuevo-comentario-w').show();
});
$('#nuevo-evento').click(function(){
	$('.nuevo-evento-w').show();
});
$('#nuevo-check').click(function(){
	$('.nuevo-check-w').show();
});
$('#nuevo-responautor').click(function(){
	$('.nuevo-responautor-w').show();
});
$('#nuevo-mapa').click(function(){
	$('.nuevo-mapa-w').show();
});
$('.cancel-w').click(function(){
