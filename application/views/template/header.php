...
<body>
		...
		<div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav btn-group">
                <li class="btn btn-inverse" ><a title="" href="<?php echo base_url()."administracion/profile_usuario"; ?>"><i class="icon icon-user"></i> <span class="text"><?php echo $this->session->userdata('username'); ?></span></a></li>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li><a href="<?php echo base_url()."procesos"; ?>"><i class="icon icon-repeat"></i> <span>Proceso</span></a></li>
